...
\caption{The impossible trinity---no single global $\eta$ can simultaneously achieve fast convergence, knowledge preservation, and optimal performance across all layers.}\label{fig:impossibility}
\end{figure}
...
We propose \textbf{Discriminative Adaptive Layer Scaling (DALS)} (\url{https://github.com/CodeOfMe/LearningRate/}), a unified optimizer that synthesizes key insights from multiple generations: phase-adaptive cosine scheduling (Gen2), LARS-style trust ratios (Gen4), and depth-aware Grokfast gradient filtering (Gen5+). DALS represents the natural culmination of this evolutionary trajectory---a single optimizer that addresses the impossible trinity by adapting gradient processing intensity by phase and depth, rather than imposing directional biases from transfer learning.
...
\caption{Five-generation evolution of learning rate strategies. DALS integrates all five generations.}\label{fig:taxonomy}
\end{figure}
...
\toprule
Strategy & Gen. & Synth. & CIFAR-10 & RTE & TREC-6 & IMDb \\
\midrule
Fixed SGD & 1 & 97.9 & 78.8 & 60.6 & 96.6 & 90.5 \\
Cosine Decay SGD & 2 & 97.6 & \textbf{80.2} & 57.8 & 94.8 & 90.7 \\
SGDR & 2 & 97.8 & 79.7 & 59.9 & 96.2 & 90.6 \\
Adam & 3 & 96.8 & 75.5 & 59.6 & \textbf{97.6} & 90.8 \\
AdamW & 3 & 96.2 & 75.7 & 60.3 & \textbf{97.6} & 90.7 \\
AdaBound & 3 & 95.5 & 75.5 & 57.4 & 92.8 & 90.0 \\
LARS & 4 & 97.7 & 74.9 & 59.6 & 95.2 & 90.0 \\
Discriminative LR & 4 & 97.1 & 77.4 & 57.8 & 84.6 & 88.6 \\
RAdam & 5 & 96.5 & 75.8 & \textbf{62.8} & 96.8 & \textbf{91.2} \\
Lion & 5 & 97.0 & 76.6 & 58.8 & 95.0 & 87.8 \\
Lookahead+AdamW & 5 & 96.0 & 75.1 & 59.9 & \textbf{97.6} & 91.1 \\
SAM & 5 & 97.5 & 76.9 & 59.2 & 96.4 & 90.5 \\
Grokfast & 5 & 97.3 & 78.5 & 56.0 & 84.4 & 89.5 \\
STLR+Discriminative & 5 & 95.9 & 79.3 & 55.2 & 43.6 & 85.4 \\
...
\begin{table}[width=\columnwidth,cols=5,pos=h]
